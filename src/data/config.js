import { Instagram, Facebook, Youtube, Heart, MapPin, Send } from 'lucide-react';
...
export const siteConfig = {
  ...
  qrRedirectUrl: "https://diosconnosotros.com", // Destino modificable del QR (/go)
  ...
  topBlocks: [
    ...
    },
    {
      ...
      type: 'map',
      title: 'Visítanos',
      embedUrl: 'https://maps.google.com/maps?q=-0.237207,-78.5166632&hl=es&z=15&output=embed',
      size: 'col-span-1 aspect-square'
    },
    {
      id: 'b1',
  ...
  // Botones de abajo
  links: [
    { id: 1, text: "Aniversario número 18", url: "https://www.facebook.com/share/r/1A86bbY1uv/", isHighlight: true },
    { id: 2, text: "Sermones domicales", url: "https://www.diosconosotros.com/lista-reproduccion/", isHighlight: true },
    { id: 3, text: "Día de las madres", url: "https://www.diosconosotros.com/homenaje-a-las-madres/", icon: Send, isHighlight: true },
